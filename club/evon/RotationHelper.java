...
public final class RotationHelper {
   ...
   private void updateRotation() {
      this.rotation = _0.t();
      this.yaw = MinecraftHelper.getClient().field_1724.field_3931;
      this.pitch = MinecraftHelper.getClient().field_1724.field_3932;
      this.prevYaw = MinecraftHelper.getClient().field_1724.field_3914;
      this.prevPitch = MinecraftHelper.getClient().field_1724.field_3916;
   }
