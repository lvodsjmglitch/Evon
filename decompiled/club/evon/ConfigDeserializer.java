...
extends zz {
    ...
    private zF() {
        Module7[] yYArray = new Module7[]{Module7.SINGLEPLAYER, Module7.MULTIPLAYER, Module7.OPTIONS, Module7.ACCOUNTS, Module7.EXIT};
    }
    ...
    protected void Category(float f, float f2, int n, int n2) {
        ...
        ConfigRestore zv2 = EvonClient.p().s();
        String[] stringArray = Property;
        Animation z72 = zv2.FontWeight(stringArray[5]);
        int n4 = 15;
        int n5 = n3;
