...
import club.evon.yg;
import club.evon.AuthScreen;
import club.evon.FontRenderer;
import club.evon.ScreenComponent;
import club.evon.UIPanel;
import club.evon.PlayerInfo;
import club.evon.PacketFilter;
...
public final class ConfigHelper3
extends TextRecord {
    private static zV X;
    private static final FontRenderer CooldownTimer;
    private static final FontRenderer EventDispatcher;
    private static final Color FontWeight;
    private static final float m = 585.0f;
    private static final float CooldownTimer = 450.0f;
    private static final int w;
    private static final int Category;
    private PlayerInfo d;
    private final AuthScreen RenderEvent;
    private final AuthScreen n;
    private final AuthScreen D;
    private final PacketFilter F;
    private final PacketFilter f;
    private final Map<String, PlayerInfo> v;
    ...
    public static synchronized zV n() {
        ...
        block4: {
            block5: {
                long l = FontWeight ^ 0x4CEE959855E9L;
                Module[] gQArray = club.evon.FontWeight.X();
                try {
                    try {
                        zV2 = X;
                        ...
                        throw zV.FontWeight(jSONException);
                    }
                    X = new zV();
                }
                catch (JSONException jSONException) {
    ...
    private zV() {
        block8: {
            block9: {
                long l = FontWeight ^ 0x40C33AC81B4FL;
                Module[] gQArray = club.evon.FontWeight.X();
                Module[] gQArray2 = gQArray;
                this.v = new LinkedHashMap<String, PlayerInfo>();
                float f = 140.0f;
                float f2 = 25.0f;
                float f3 = 10.0f;
                this.RenderEvent = new AuthScreen(AuthProvider.COOKIE, 140.0f, 25.0f, 10.0f);
                this.n = new AuthScreen(AuthProvider.MICROSOFT, 140.0f, 25.0f, 10.0f);
                this.D = new AuthScreen(AuthProvider.TOKEN, 140.0f, 25.0f, 10.0f);
                this.F = new PacketFilter(yI.LOGIN, 88.0f, 25.0f, 10.0f);
                this.f = new PacketFilter(yI.REMOVE, 88.0f, 25.0f, 10.0f);
                for (JsonArray jsonArray : HypixelPacketHandler.p().k().StaticEventBus().asMap().entrySet().stream().map(entry -> ((JsonElement)entry.getValue()).getAsJsonArray()).toList()) {
                    try {
                        this.g(jsonArray);
                        if (gQArray2 == null) {
            ...
            zV2.d = this.v.values().stream().toList().getFirst().StaticEventBus();
        }
    }

    public void g(JsonArray jsonArray) {
        long l = FontWeight ^ 0x7F16712BF868L;
        String string = jsonArray.get(0).getAsString();
        Module[] gQArray = club.evon.FontWeight.X();
        try {
            this.v.put(string, new PlayerInfo(string, jsonArray.get(1).getAsString(), UUID.fromString(jsonArray.get(2).getAsString()), yg.q((int)jsonArray.get(3).getAsInt()), 181.66667f, 55.0f, 10.0f));
            if (Module.q() == null) {
                club.evon.FontWeight.R((Module[])new Module[1]);
            }
        }
        catch (JSONException jSONException) {
            throw zV.FontWeight(jSONException);
    ...
    public void J(String string) {
        block4: {
            Object object;
            block5: {
                long l = FontWeight ^ 0x5E32104A52A5L;
                Module[] gQArray = club.evon.FontWeight.X();
                try {
                    try {
                        object = this.d.M();
    ...
    protected void Category(float f, float f2, int n, int n2) {
        ...
        block13: {
            ...
            block14: {
                ...
                float f9;
                block11: {
                    long l = FontWeight ^ 0x35891662B821L;
                    float f10 = 20.0f;
                    ...
                    f4 = f7;
                    float f11 = 15.0f;
                    gQArray = club.evon.FontWeight.X();
                    float f12 = 20.0f;
                    ...
                    float f13 = f5 + 25.5f;
                    float f14 = f4 + 33.0f;
                    float f15 = EventDispatcher.i(stringArray[6], 13.5f);
                    Y.G((float)f5, (float)f4, (float)f6, (float)f9, (float)15.0f);
                    StringArrayHelper.CooldownTimer((float)f5, (float)f4, (float)f6, (float)f9, (float)15.0f, (Color)FontWeight);
                    int n4 = 1;
                    ...
                    while (n6 < n5) {
                        block12: {
                            ...
                            EventDispatcher.U(n4 + ".", f8, f14, 15.0f, Color.WHITE.getRGB());
                            ...
                            for (int i = 0; i < n7; ++i) {
                                ...
                                EventDispatcher.U(string3, f13, f14, 13.5f, n3);
                                f14 += f15 - 2.0f;
                                try {
                    ...
                    zV.Category((float)f5, (float)f4, (float)f6, (float)f9, (float)15.0f);
                    CooldownTimer.U(string, f5 + zV.L(f6, string, CooldownTimer, 20.0f), f4 + 10.0f, 20.0f, Color.WHITE.getRGB());
                    f4 += f9 + 10.0f;
                    f9 = 133.0f;
                ...
                f3 = f5 + (f6 - this.RenderEvent.StaticEventBus()) / 2.0f;
                float f16 = f4 + 36.0f;
                f8 = 20.0f;
                this.RenderEvent.M(f3, f16, f, f2);
                this.n.M(f3, f16 += this.RenderEvent.I() + 4.0f, f, f2);
                ...
                this.f.M(f3 + this.F.StaticEventBus() + (this.d.u() - this.F.StaticEventBus() * 2.0f), f4 + 99.0f, f, f2);
            }
            f4 = f7;
            Y.G((float)(f5 += f6 + 20.0f), (float)f4, (float)585.0f, (float)450.0f, (float)15.0f);
            StringArrayHelper.CooldownTimer((float)f5, (float)f4, (float)585.0f, (float)450.0f, (float)15.0f, (Color)FontWeight);
            zV.Category((float)f5, (float)f4, (float)585.0f, (float)450.0f, (float)15.0f);
            f3 = f5 += 10.0f;
            f4 += 10.0f;
        }
        int n8 = 0;
        for (PlayerInfo zN2 : this.v.values()) {
            block17: {
                block15: {
                    block16: {
                        try {
    ...
    protected void s(double d, double d2, int n) {
                        ...
                        block41: {
                            block42: {
                                block39: {
                                    block40: {
                                        block37: {
                                            block38: {
                                                block35: {
                                                    block36: {
                                                        long l = FontWeight ^ 0x5EA5E47A78B3L;
                                                        gQArray = club.evon.FontWeight.X();
                                                        try {
                                                            n2 = n;
                                                    ...
                                                    n2 = CollisionHelper.J(d, d2, ((ScreenComponent)((Object)this.RenderEvent)).M(), this.RenderEvent.S(), this.RenderEvent.StaticEventBus(), this.RenderEvent.I()) ? 1 : 0;
                                                }
                                                try {
                                                    try {
                                            ...
                                            n2 = CollisionHelper.J(d, d2, ((ScreenComponent)((Object)this.n)).M(), this.n.S(), this.n.StaticEventBus(), this.n.I()) ? 1 : 0;
                                        }
                                        try {
                                            try {
                                    ...
                                    n2 = CollisionHelper.J(d, d2, ((ScreenComponent)((Object)this.D)).M(), this.D.S(), this.D.StaticEventBus(), this.D.I()) ? 1 : 0;
                                }
                                try {
                                    try {
                            ...
                            n2 = CollisionHelper.J(d, d2, this.F.M(), this.F.S(), this.F.StaticEventBus(), this.F.I()) ? 1 : 0;
                        }
                        try {
                            try {
                            ...
                            this.F.RenderEvent(this.d.M());
                            this.F.Property(this.d.FontWeight());
                            this.F.y();
                        }
                        catch (JSONException jSONException) {
                            throw zV.FontWeight(jSONException);
        ...
        for (PlayerInfo zN3 : zV2.v.values()) {
            block47: {
                PlayerInfo zN4;
                block48: {
                    try {
                        block49: {
                            try {
                                try {
                                    try {
                                        try {
                                            if (!CollisionHelper.J(d, d2, zN3.Category(), zN3.X(), zN3.u(), zN3.StaticEventBus())) break block47;
                                            zN4 = this.d;
    ...
    protected void j(int n) {
        block4: {
            block5: {
                long l = FontWeight ^ 0x31A5583A14BFL;
                Module[] gQArray = club.evon.FontWeight.X();
                try {
                    try {
                        if (gQArray != null) break block4;
    ...
    private static float L(float f, String string, FontRenderer z72, float f2) {
    ...
    static {
        block16: {
            block15: {
                block14: {
                    block13: {
                        zV.FontWeight = ObfuscationHelper.FontWeight((long)5061095152453542543L, (long)-8488319479886691138L, MethodHandles.lookup().lookupClass()).FontWeight(109374495925841L);
                        var11 = zV.FontWeight ^ 64791931289999L;
                        ...
                        var18_5 = 0;
                        var17_6 = "s}r\u00c2\u0081\u00947\u0084\u0010\u00e2\u0094=q.%\u00e4\u00d0\u00ff\u00a3\u001d\u0019\u000e\u0087\u00b8W\u0018\u00bdNnwB}\u00faT4\u001d\u0093\u000e\n\u00acEKG\u0083!I\u00e2;\u00d5R Np=x\u000e\u00b3=\u00bdM\u0011v(\u0013\u00e0\u0000\u00ac\u00cdPU\u0097<\u00c5K\u00d0\u0000\u00f2\u00c1J\u008d\u00da\u00df\u00a60\u00d1\u00edKP/\u00ccI\u00da\u00e4\u00c7\u00a9\u0014N\u00acj~\u0015R0~jEZ)FontWeight\u00037\u00a5g`\u0097d\u00d8\u00e4!\u001a\u0015\u00eb\r\u0017\u00c6\u009d\u00ee\u0017Zo\u00c2Vh\u0005w\u00b2\u0007\u00ed\u00eafLX\u00f5\u00a0h\u001a\u00ed_\u00165\u0087P7\u00e1\u00e0\u00f2\u00f9\u00bd\u00f4\u00117\u008c\u00a0P\u0096R\u00f7b\u009f\u0004\Category{\u00f1\u00f1\u0015,\u0096\u0089\u00d6\u00ae\u0096\Category\u00e0r\u00ed\u00f1\\\u00d1U+PJ\u00bb\u00cdC\u009b'v\u00a0\u0000\u008b\u0016\u00efuZx\u00ac\u008d\u00f6\u00f1\u00d3\u00ef\u00db'\u008c:w\u00fe>6\u0003\u00961U\u00a9\u00c3\u008cW\u00f9\u00ae\u0094\u0092\f(\u0001\u0092O\Property\u0096 \u00ee.\u008bw\u0092\u0005\u0010\u0018\u00ca\u00c0xO\u00cbm\u00aa8\u00fa`;\u00ce\u0016\u00d9O";
                        var19_7 = "s}r\u00c2\u0081\u00947\u0084\u0010\u00e2\u0094=q.%\u00e4\u00d0\u00ff\u00a3\u001d\u0019\u000e\u0087\u00b8W\u0018\u00bdNnwB}\u00faT4\u001d\u0093\u000e\n\u00acEKG\u0083!I\u00e2;\u00d5R Np=x\u000e\u00b3=\u00bdM\u0011v(\u0013\u00e0\u0000\u00ac\u00cdPU\u0097<\u00c5K\u00d0\u0000\u00f2\u00c1J\u008d\u00da\u00df\u00a60\u00d1\u00edKP/\u00ccI\u00da\u00e4\u00c7\u00a9\u0014N\u00acj~\u0015R0~jEZ)FontWeight\u00037\u00a5g`\u0097d\u00d8\u00e4!\u001a\u0015\u00eb\r\u0017\u00c6\u009d\u00ee\u0017Zo\u00c2Vh\u0005w\u00b2\u0007\u00ed\u00eafLX\u00f5\u00a0h\u001a\u00ed_\u00165\u0087P7\u00e1\u00e0\u00f2\u00f9\u00bd\u00f4\u00117\u008c\u00a0P\u0096R\u00f7b\u009f\u0004\Category{\u00f1\u00f1\u0015,\u0096\u0089\u00d6\u00ae\u0096\Category\u00e0r\u00ed\u00f1\\\u00d1U+PJ\u00bb\u00cdC\u009b'v\u00a0\u0000\u008b\u0016\u00efuZx\u00ac\u008d\u00f6\u00f1\u00d3\u00ef\u00db'\u008c:w\u00fe>6\u0003\u00961U\u00a9\u00c3\u008cW\u00f9\u00ae\u0094\u0092\f(\u0001\u0092O\Property\u0096 \u00ee.\u008bw\u0092\u0005\u0010\u0018\u00ca\u00c0xO\u00cbm\u00aa8\u00fa`;\u00ce\u0016\u00d9O".length();
                        var16_8 = 8;
                        var15_9 = -1;
lbl19:
                        // 2 sources
...
lbl24:
                        ...
                        while (true) {
                            var20_4[var18_5++] = zV.FontWeight(var21_10).intern();
...
lbl50:
                ...
                var0_13 = new long[2];
                var4_14 = 0;
                var5_15 = "7\u00a0\u0015Y\u0087M\u00e8y\u00f4\u00e4!FontWeight\u00b6\u00df\u00e1\u009b";
                var6_16 = "7\u00a0\u0015Y\u0087M\u00e8y\u00f4\u00e4!FontWeight\u00b6\u00df\u00e1\u009b".length();
                var3_17 = 0;
                while (true) {
                    break block15;
                    break;
...
lbl70:
        ...
        zV.Category = (int)var0_13[0];
        zV.w = (int)var0_13[1];
        var11_1 = zV.Property;
        zV.CooldownTimer = HypixelPacketHandler.p().s().FontWeight(var11_1[1]);
        zV.EventDispatcher = HypixelPacketHandler.p().s().FontWeight(var11_1[8]);
        zV.FontWeight = new Color(11, 5, 18, 50);
    }
