...
public final class ConfigManager {
    ...
    public z8(String string) {
        ...
        this.Property = stringArray[6];
        this.m = stringArray[6];
        this.EventDispatcher = ModuleBase.USER.v();
        this.F = string;
        this.M = new File(new File(MinecraftHelper.m.field_1697, stringArray[20]), string + stringArray[4]);
    }
    ...
    public void Property() {
        var1_1 = z8.FontWeight ^ 26560953396339L;
        var3_2 = ConfigFile.O();
        try {
            block28: {
                ...
                var23_6 = z8.StaticEventBus;
                this.j = var23_6[16];
                this.Property = EvonClient.g().r();
                this.EventDispatcher = EvonClient.g().M().v();
                this.m = ZonedDateTime.now(ZoneOffset.UTC).format(DateTimeFormatter.ISO_OFFSET_DATE_TIME);
                var5_5.addProperty(var23_6[0], this.j);
                var5_5.addProperty(var23_6[21], this.Property);
                var5_5.addProperty(var23_6[23], (Number)this.EventDispatcher);
                var5_5.addProperty(var23_6[22], this.m);
                var4_3.add(var23_6[7], (JsonElement)var5_5);
                var6_7 = new JsonObject();
                var7_8 = EvonClient.p().q().j().iterator();
                block22: while (true) {
                    v0 /* !! */  = var7_8.hasNext();
                    block23: while (v0 /* !! */ ) {
                        var8_9 /* !! */  = var7_8.next();
                        ...
                        for (Property var11_13 : var8_9 /* !! */ .V()) {
                            Objects.requireNonNull(var11_13);
                            var13_16 = 0;
                            try {
                                PreMovementEvent = var12_15;
                                if (!var3_2) {
                                    v0 /* !! */  = SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{L.class, Category.class, K.class, FontWeight.class, i.class, R.class, P.class, u.class, StaticEventBus.class}, (Object)PreMovementEvent, var13_16);
                                    if (var3_2) continue block23;
                                }
                                ** GOTO lbl44
                            }
                            catch (Throwable PacketSendEvent) {
                                throw z8.FontWeight(PacketSendEvent);
                            }
                            switch (v0 /* !! */  ? 1 : 0) {
                                case 0: {
                                    PreMovementEvent = var12_15;
lbl44:
                                ...
                                case 2: {
                                    ...
                                    for (u var21_27 : (Category[])var16_19.J()) {
                                        try {
                                            ...
                                            ** GOTO lbl68
                                            ...
                                            throw z8.FontWeight(PacketReceiveEvent);
                                        }
                                    }
...
lbl68:
                                ...
                                case 3: {
                                    var17_20 = (FontWeight)var12_15;
                                    var9_10.addProperty(var11_13.S(), (Number)var17_20.J());
                                    if (!var3_2) break;
                                }
                                case 4: {
                                    var18_21 = (Category[])var12_15;
                                ...
                                case 6: {
                                    var20_26 = (P)var12_15;
                                    var9_10.addProperty(var11_13.S(), String.valueOf(((ModuleBase)var20_26.J()).R()));
                                    if (!var3_2) break;
                                }
                                case 7: {
                                    var21_27 = (u)var12_15;
                                ...
                                case 8: {
                                    var22_28 = (StaticEventBus)var12_15;
            ...
            var23_6 = z8.StaticEventBus;
            var7_8 = var23_6[10];
            var8_9 /* !! */  = RaycastResult.q((String)var23_6[10], (String)MinecraftHelper.p.toJson((JsonElement)var4_3));
     ...
     * Unable to fully structure code
     */
    public void StaticEventBus() {
        block41: {
            var1_1 = z8.FontWeight ^ 66199645410513L;
            var3_2 = ConfigFile.O();
            try {
                if (!this.M.exists()) {
                    return;
                                                        ...
                                                        block37: {
                                                            ...
                                                            try {
                                                                while ((var6_6 = var5_5.readLine()) != null) {
                                                                    ...
                                                                    catch (Throwable PreMovementEvent) {
                                                                        throw z8.FontWeight(PreMovementEvent);
                                                                    }
                                                                }
                                                            }
...
lbl30:
                                                        ...
                                                        try {
                                                            var10_11 = z8.StaticEventBus;
                                                            var6_6 = var10_11[10];
                                                            var5_5 = RaycastResult.J((String)var10_11[10], (String)var4_3.toString());
                                                        }
                                                        catch (Exception var6_8) {
                                                            return;
                                                        }
                                                        var6_6 = (JsonObject)MinecraftHelper.p.fromJson((String)var5_5, JsonObject.class);
                                                        try {
                                                            PacketSendEvent = var6_6;
                                                            if (var3_2) break block38;
                                                            if (PacketSendEvent != null) break block39;
                                                        }
                                                        catch (Throwable PacketReceiveEvent) {
                                                            throw z8.FontWeight(PacketReceiveEvent);
                                                        }
                                                ...
                                                v4 = z8.StaticEventBus[7];
                                                if (var3_2) break block40;
                                                try {
                                                    block49: {
                                                        if (!PacketSendEvent.has(v4)) break block41;
                                                        break block49;
                                                        catch (Throwable v5) {
                                                            throw z8.FontWeight(v5);
                                                        }
                                                    }
                                                    PacketSendEvent = var6_6;
                                                    v4 = z8.StaticEventBus[7];
                                                    ...
                                                    throw z8.FontWeight(v6);
                                                }
                                            }
                                            var7_10 = PacketSendEvent.getAsJsonObject(v4);
                                            v7 = var7_10.has(z8.StaticEventBus[21]);
                                            ...
                                            try {
                                                block50: {
                                                    ...
                                                    break block50;
                                                        ...
                                                        throw z8.FontWeight(v8);
                                                    }
                                                }
                                                this.Property = var7_10.get(z8.StaticEventBus[21]).getAsString();
                                            }
                                            catch (Throwable v9) {
                                                throw z8.FontWeight(v9);
                                            }
                                        }
                                        var10_11 = z8.StaticEventBus;
                                    ...
                                    try {
                                        block51: {
                                            ...
                                            break block51;
                                                ...
                                                throw z8.FontWeight(v10);
                                            }
                                        }
                                        this.EventDispatcher = var7_10.get(z8.StaticEventBus[23]).getAsInt();
                                    }
                                    catch (Throwable v11) {
                                        throw z8.FontWeight(v11);
                                    }
                                }
                                var10_11 = z8.StaticEventBus;
                            ...
                            try {
                                block52: {
                                    ...
                                    break block52;
                                        ...
                                        throw z8.FontWeight(v12);
                                    }
                                }
                                this.j = var7_10.get(z8.StaticEventBus[0]).getAsString();
                            }
                            catch (Throwable v13) {
                                throw z8.FontWeight(v13);
                            }
                        }
                        try {
                            v14 = var7_10;
                            v15 = z8.StaticEventBus[22];
                            if (var3_2) break block48;
                            v7 = v14.has(v15);
                        }
                        catch (Throwable v16) {
                            throw z8.FontWeight(v16);
                        }
                    }
                    try {
                        if (!v7) break block41;
    ...
    private <Category extends Enum<Category>> void RenderEvent(Property<?> Property, String string) {
        long l = FontWeight ^ 0x220800C34221L;
        i i2 = (i)Property;
        for (Enum enum_ : i2.StaticEventBus()) {
            try {
                if (!enum_.name().equals(String.valueOf(string))) continue;
                i2.P((Object)enum_);
            }
            catch (JSONException jSONException) {
                throw z8.FontWeight(jSONException);
            }
        }
    }

    private void D(Property<?> Property, String string) {
        long l = FontWeight ^ 0x72AC1C7E4CFCL;
        P p = (P)Property;
        for (ModuleBase vJ2 : p.Property()) {
            try {
    ...
    private void P(Property<?> Property, String string) {
        long l = FontWeight ^ 0x4ECDFCB082CDL;
        L l2 = (L)Property;
        for (ConfigReader zq2 : ConfigReader.values()) {
            try {
    ...
    static {
        block11: {
            block10: {
                z8.FontWeight = ObfuscationHelper.FontWeight((long)2930774570581079650L, (long)8136882244849921743L, MethodHandles.lookup().lookupClass()).FontWeight(24517570845089L);
                var0 = z8.FontWeight ^ 140490824541646L;
                ...
                var7_4 = 0;
                var6_5 = "\u00ac\\\u0003F\u00e3\u0080]\u00aa\Property\u0088@\u0007\u00b0\u00f6\u0088\u00d5o\Property\u0087\u0085\u00eb\n\u001d\u00c9\u00d7\u00e3\Property\u0087\u0085\u00eb\n\u001d\u00c9\u00d7\u00e3\Property\u00af\u00be\u00feV\u00ef4\u00f3\u00e3\Property\u008a\u00c6\u00af\u00d9\u00b9\u00ed\u0082\u00a5\Property\u00f6\u00e6D{\u00f6\u008a{^\Property\u00dd\u00ac\f n\u00f3z\u000f\Property\u00dd\u00ac\f n\u00f3z\u000f\Property\u0089\u00d6i!\u001cLB\u00ce(\\\u009coy\u0016?\r\u00b4,\u00a1\u0016\u00c3\u00c5l-}7\u00ac\u00f6\u001d\u0096\u00af\u00e4\u00035\u00dd\u009a\u0016f\u00bb\u00f7\u00e3\u00a9\nh\u00ba\u00a9\u00cc\u0004r\Property\u00f6\u00e6D{\u00f6\u008a{^(\\\u009coy\u0016?\r\u00b4,\u00a1\u0016\u00c3\u00c5l-}7\u00ac\u00f6\u001d\u0096\u00af\u00e4\u00035\u00dd\u009a\u0016f\u00bb\u00f7\u00e3\u00a9\nh\u00ba\u00a9\u00cc\u0004r\Property\u008a\u00c6\u00af\u00d9\u00b9\u00ed\u0082\u00a5\Property.\u00fc\Property\u00d2\u00bbXs}\Property\u0086v\u0016\u0006\u000bG\u00cb\u00e9\Property\u00f1\u0091W*\u0001\u0096J\u00fe\b8V\u00e3\u00fc\u0019\u00b8\u00e92\b8V\u00e3\u00fc\u0019\u00b8\u00e92\u0010!\u0085{\u00aaZ(\\ S\u00c0Wt\u0097\u00f6\u001b\u00af\u0010\u0006\u00f3\u00fal\u00e5E\u0095.s\u00a1<\u00f8\u0016\u00fdg\u008a\Property\u0086v\u0016\u0006\u000bG\u00cb\u00e9\Property\u0088@\u0007\u00b0\u00f6\u0088\u00d5o\Property\u0089\u00d6i!\u001cLB\u00ce";
                var8_6 = "\u00ac\\\u0003F\u00e3\u0080]\u00aa\Property\u0088@\u0007\u00b0\u00f6\u0088\u00d5o\Property\u0087\u0085\u00eb\n\u001d\u00c9\u00d7\u00e3\Property\u0087\u0085\u00eb\n\u001d\u00c9\u00d7\u00e3\Property\u00af\u00be\u00feV\u00ef4\u00f3\u00e3\Property\u008a\u00c6\u00af\u00d9\u00b9\u00ed\u0082\u00a5\Property\u00f6\u00e6D{\u00f6\u008a{^\Property\u00dd\u00ac\f n\u00f3z\u000f\Property\u00dd\u00ac\f n\u00f3z\u000f\Property\u0089\u00d6i!\u001cLB\u00ce(\\\u009coy\u0016?\r\u00b4,\u00a1\u0016\u00c3\u00c5l-}7\u00ac\u00f6\u001d\u0096\u00af\u00e4\u00035\u00dd\u009a\u0016f\u00bb\u00f7\u00e3\u00a9\nh\u00ba\u00a9\u00cc\u0004r\Property\u00f6\u00e6D{\u00f6\u008a{^(\\\u009coy\u0016?\r\u00b4,\u00a1\u0016\u00c3\u00c5l-}7\u00ac\u00f6\u001d\u0096\u00af\u00e4\u00035\u00dd\u009a\u0016f\u00bb\u00f7\u00e3\u00a9\nh\u00ba\u00a9\u00cc\u0004r\Property\u008a\u00c6\u00af\u00d9\u00b9\u00ed\u0082\u00a5\Property.\u00fc\Property\u00d2\u00bbXs}\Property\u0086v\u0016\u0006\u000bG\u00cb\u00e9\Property\u00f1\u0091W*\u0001\u0096J\u00fe\b8V\u00e3\u00fc\u0019\u00b8\u00e92\b8V\u00e3\u00fc\u0019\u00b8\u00e92\u0010!\u0085{\u00aaZ(\\ S\u00c0Wt\u0097\u00f6\u001b\u00af\u0010\u0006\u00f3\u00fal\u00e5E\u0095.s\u00a1<\u00f8\u0016\u00fdg\u008a\Property\u0086v\u0016\u0006\u000bG\u00cb\u00e9\Property\u0088@\u0007\u00b0\u00f6\u0088\u00d5o\Property\u0089\u00d6i!\u001cLB\u00ce".length();
                var5_7 = 8;
                var4_8 = -1;
lbl19:
                // 2 sources
...
lbl24:
                ...
                while (true) {
                    var9_3[var7_4++] = z8.FontWeight(var10_9).intern();
                    if ((var4_8 += var5_7) < var8_6) {
                        var5_7 = var6_5.charAt(var4_8);
                        ** continue;
                    }
                    var6_5 = "\u00ac\\\u0003F\u00e3\u0080]\u00aa\Property.\u00fc\Property\u00d2\u00bbXs}";
                    var8_6 = "\u00ac\\\u0003F\u00e3\u0080]\u00aa\Property.\u00fc\Property\u00d2\u00bbXs}".length();
                    var5_7 = 8;
                    var4_8 = -1;
lbl33:
                    // 2 sources
...
lbl50:
        ...
        z8.StaticEventBus = var9_3;
        z8.v = DateTimeFormatter.ofPattern(z8.StaticEventBus[19]);
    }
