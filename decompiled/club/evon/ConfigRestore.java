...
extends zz {
    private static zV X;
    private static final Animation CooldownTimer;
    private static final Animation EventDispatcher;
    ...
    private zV() {
        block8: {
            block9: {
                ...
                for (JsonArray jsonArray : EvonClient.p().k().StaticEventBus().asMap().entrySet().stream().map(entry -> ((JsonElement)entry.getValue()).getAsJsonArray()).toList()) {
                    try {
                        this.g(jsonArray);
                        if (gQArray2 == null) {
                        ...
                        block41: {
                            block42: {
                                block39: {
                                        ...
                                        block37: {
                                            block38: {
                                                block35: {
                                                    ...
                                                    n2 = CollisionHelper.J(d, d2, ((ScreenBase)((Object)this.RenderEvent)).M(), this.RenderEvent.S(), this.RenderEvent.StaticEventBus(), this.RenderEvent.I()) ? 1 : 0;
                                                }
                                                try {
                                                    try {
                                            ...
                                            n2 = CollisionHelper.J(d, d2, ((ScreenBase)((Object)this.n)).M(), this.n.S(), this.n.StaticEventBus(), this.n.I()) ? 1 : 0;
                                        }
                                        try {
                                            try {
                                    ...
                                    n2 = CollisionHelper.J(d, d2, ((ScreenBase)((Object)this.D)).M(), this.D.S(), this.D.StaticEventBus(), this.D.I()) ? 1 : 0;
                                }
                                try {
                                    try {
    ...
    protected void j(int n) {
        block4: {
            ...
            Y.S((zz)zL.StaticEventBus());
        }
    }

    private static float L(float f, String string, Animation z72, float f2) {
...
lbl70:
        ...
        zV.w = (int)var0_13[1];
        var11_1 = zV.Property;
        zV.CooldownTimer = EvonClient.p().s().FontWeight(var11_1[1]);
        zV.EventDispatcher = EvonClient.p().s().FontWeight(var11_1[8]);
