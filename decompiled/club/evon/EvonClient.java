...
implements class_8710 {
            ...
            block5: {
                ...
                try {
                    try {
                        ...
                        throw zY.FontWeight(unsupportedOperationException);
                    }
    ...
    public boolean o() {
        boolean bl;
        long l = FontWeight ^ 0x4579623BA7A5L;
        try {
            bl = this.L != null;
        }
        catch (UnsupportedOperationException unsupportedOperationException) {
    ...
    public static class_9139<class_2540, zY> StaticEventBus(class_8710.class_9154<zY> class_91542) {
     ...
     */
    static {
        FontWeight = ObfuscationHelper.FontWeight((long)-2813459727749272163L, (long)2805387817495384559L, MethodHandles.lookup().lookupClass()).FontWeight(28739829419961L);
        long l = FontWeight ^ 0x4EFCA8F00CBDL;
        zY.y(null);
        ...
        while (true) {
            if (n >= 8) {
                ...
                byte[] byArray3 = cipher.doFinal("\u00fdH\u00dd0Y\u0018r#\u00e1\Category\u00ca\u0003\u008f\u00d4\Property\u00ad\u0014\u00ee\u0004\u0080\u00ee\u00fe\u00ceE\u008f4A\u000b\u0003.R8\u00d0y\u009e_\u00a1\u00fa\u0002\u00d0".getBytes("ISO-8859-1"));
                Property = zY.FontWeight(byArray3).intern();
                return;
            }
            byArray2 = byArray2;
    ...
    private static UnsupportedOperationException FontWeight(UnsupportedOperationException unsupportedOperationException) {
