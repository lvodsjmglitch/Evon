            ...
            block5: {
                ...
                try {
                    try {
                        ...
                        if (KillEffect.m.field_1724 != null) break block5;
                    }
                    catch (JSONException jSONException) {
                        throw yR.FontWeight(jSONException);
                    }
    ...
    public void Y() {
        ...
        block2: {
            block3: {
                ...
                try {
                    class_7462 = KillEffect.m.field_1724;
        ...
        class_7462.method_18799(KillEffect.m.field_1724.method_18798().method_18805(0.0, 1.0, 0.0));
        super.Y();
    }
        ...
        block8: {
            ...
            block7: {
                ...
                try {
                    ...
                    bl = KillEffect.m.field_1724.method_24828();
                }
                catch (JSONException jSONException) {
                    throw yR.FontWeight(jSONException);
                }
        ...
        block14: {
            ...
            block15: {
                ...
                try {
                    try {
                        try {
                            if (KillEffect.m.field_1724 == null) break block14;
                        ...
                        if (class_27432.method_11818() != KillEffect.m.field_1724.method_5628()) break block14;
                    }
                    catch (JSONException jSONException) {
                        throw yR.FontWeight(jSONException);
                    }
    ...
    private void P(VelocityUpdateEvent z02) {
        block29: {
                                        ...
                                        block23: {
                                            ...
                                            try {
                                                try {
                                                    try {
                                                        try {
                                                            n = KillEffect.m.field_1724.method_24828();
                                                        ...
                                                        yR yR2 = this;
                                                        d2 = 0.48;
                                                        n4 = KillEffect.m.field_1724.method_6059(class_1294.field_5904);
                                                ...
                                                n4 = KillEffect.m.field_1724.method_6112(class_1294.field_5904).method_5578();
                                                break block22;
                                            }
                                            catch (JSONException jSONException) {
                                                throw yR.FontWeight(jSONException);
                            ...
                            try {
                                try {
                                    try {
                                        ...
                                        yR yR3 = this;
                                        d = 0.345;
                                        n2 = KillEffect.m.field_1724.method_6059(class_1294.field_5904);
                                ...
                                n2 = KillEffect.m.field_1724.method_6112(class_1294.field_5904).method_5578();
                                break block26;
                            }
                            catch (JSONException jSONException) {
                                throw yR.FontWeight(jSONException);
            ...
            try {
                ...
                KillEffect.m.field_1724.method_18799(KillEffect.m.field_1724.method_18798().method_18805(0.0, 1.0, 0.0));
            }
            catch (JSONException jSONException) {
                throw yR.FontWeight(jSONException);
            }
