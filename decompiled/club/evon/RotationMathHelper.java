...
import club.evon.RaycastHelper;
...
public final class RotationMathHelper {
    ...
    public static class_241 I(class_241 class_2412, class_241 class_2413, float f, float f2) {
        ...
        block4: {
            block5: {
                long l = FontWeight ^ 0x45A79AD02164L;
                ...
                try {
                    try {
                        ...
                        throw _0.FontWeight(jSONException);
                    }
    ...
    public static class_241 Category() {
        return new class_241(MinecraftHelper.m.field_1724.method_36454(), MinecraftHelper.m.field_1724.method_36455());
    }
    ...
    public static class_241 S(class_241 class_2412, class_241 class_2413) {
        double d = (Double)MinecraftHelper.m.field_1690.method_42495().method_41753() * (double)0.6f + (double)0.2f;
        double d2 = d * d * d * 8.0;
    ...
    public static float J(double d) {
        double d2 = (Double)MinecraftHelper.m.field_1690.method_42495().method_41753() * (double)0.6f + (double)0.2f;
        double d3 = d2 * d2 * d2 * 8.0;
        return (float)(_0.P(d, d3) * d3) * 0.15f;
    }

    public static class_241 RenderEvent(class_241 class_2412) {
        return _0.s(_0.S(class_2412, _0.Category()));
    }
    ...
    public static class_241 m(class_241 class_2412) {
        class_241 class_2413 = _0.RenderEvent(class_2412);
        float f = _0.s(class_2413.field_1343, MinecraftHelper.m.field_1724.method_36454());
    ...
    public static boolean g(class_1297 class_12972, float f) {
        ...
        block2: {
            block3: {
                long l = FontWeight ^ 0x6F7C08B8843FL;
                class_241 class_2412 = _0.q(class_12972.method_33571());
                double d2 = class_3532.method_15356((float)RotationManager.M().d(MinecraftHelper.m.field_1724.method_36454()), (float)class_2412.field_1343);
                String[] stringArray = StringArrayHelper.K();
                double d3 = class_3532.method_15356((float)RotationManager.M().Q(MinecraftHelper.m.field_1724.method_36455()), (float)class_2412.field_1342);
                try {
    ...
    @Nullable
    public static RaycastResult FontWeight(class_1309 class_13092, class_243 class_2432, double d) {
        ArrayList arrayList;
        block19: {
            ArrayList<RaycastResult> arrayList2;
            block16: {
                class_241 class_2412;
                block21: {
                    long l = FontWeight ^ 0x7218F0D212B3L;
                    com.google.common.base.Predicate predicate = class_12972 -> {
                        boolean bl;
                        long l = FontWeight ^ 0x9C2F2704639L;
                        try {
                    ...
                    arrayList2 = new ArrayList<RaycastResult>();
                    class_241 class_2413 = _0.q(class_2432);
                    float f = (float)MathUtil.F((double)0.01, (double)0.05);
                    class_241 class_2414 = new class_241(MathUtil.Property((float)(-f), (float)f), MathUtil.Property((float)(-f), (float)f));
                    class_241 class_2415 = class_2413.method_35586(class_2414);
                    class_2412 = _0.m(class_2415);
                    class_3966 class_39662 = RaycastHelper.d((double)d, (float)1.0f, (float)class_2412.field_1343, (float)class_2412.field_1342, (Predicate)predicate);
                    try {
                        if (class_39662 != null) {
                            return new RaycastResult(class_2412, (class_239)class_39662);
                        }
                    }
                    catch (JSONException jSONException) {
                        throw _0.FontWeight(jSONException);
                                ...
                                while (d11 < d10) {
                                    block18: {
                                        block20: {
                                            ...
                                            class_3966 class_39663 = RaycastHelper.d((double)d, (float)1.0f, (float)class_2416.field_1343, (float)class_2416.field_1342, (Predicate)predicate);
                                            try {
                                                try {
                                                    try {
                                                ...
                                                arrayList2.add(new RaycastResult(class_2416, (class_239)class_39663));
                                            }
                                            catch (JSONException jSONException) {
                                                throw _0.FontWeight(jSONException);
                                            }
                ...
                arrayList2.sort(Comparator.comparingDouble(yB2 -> _0.RenderEvent(yB2.nU(), class_2412)));
            }
            arrayList = arrayList2.getFirst();
        }
        return (RaycastResult)arrayList;
    }

    @Nullable
    public static RaycastResult s(class_1297 class_12972, class_243 class_2432, double d) {
        RaycastResult yB3;
        ArrayList arrayList;
        block22: {
            ArrayList<RaycastResult> arrayList2;
            block19: {
                class_241 class_2412;
                block24: {
                    long l = FontWeight ^ 0x4E748400B246L;
                    com.google.common.base.Predicate predicate = class_12973 -> {
                        boolean bl;
                        long l = FontWeight ^ 0x199CBA77DC31L;
                        try {
        ...
        try {
            yB3 = (RaycastResult)arrayList;
            if (Module.q() == null) {
                StringArrayHelper.k((String[])new String[3]);
            }
        }
        catch (JSONException jSONException) {
            throw _0.FontWeight(jSONException);
    ...
    public static class_241 q(class_243 class_2432) {
        return _0.g(MinecraftHelper.m.field_1724.method_33571(), class_2432);
    }
    ...
    public static class_243 FontWeight(float f, class_1297 class_12972) {
    ...
    public static class_241 K(class_2338 class_23382, class_2350 class_23502) {
        class_241 class_2412;
        long l = FontWeight ^ 0x147ABE2046DL;
        float f = (float)((double)class_23382.method_10263() + 0.5 - MinecraftHelper.m.field_1724.method_23317() + (double)class_23502.method_10148() * 0.5);
        String[] stringArray = StringArrayHelper.K();
        float f2 = (float)(MinecraftHelper.m.field_1724.method_23318() + (double)MinecraftHelper.m.field_1724.method_18381(MinecraftHelper.m.field_1724.method_18376()) - (double)class_23382.method_10264() - (double)class_23502.method_10164() * 0.5);
        float f3 = (float)((double)class_23382.method_10260() + 0.5 - MinecraftHelper.m.field_1724.method_23321() + (double)class_23502.method_10165() * 0.5);
    ...
    @Nullable
    public static RaycastResult I(class_2338 class_23382, class_2350 class_23502, class_241 class_2412, class_243 class_2432) {
        ArrayList arrayList;
        block26: {
            ArrayList<RaycastResult> arrayList2;
            block23: {
                block29: {
                    long l = FontWeight ^ 0x2D4082642F2AL;
                                    ...
                                    block25: {
                                        block27: {
                                            ...
                                            block28: {
                                                ...
                                                class_2393 = RaycastHelper.R((double)MinecraftHelper.m.field_1724.method_55754(), (boolean)false, (float)class_2413.field_1343, (float)class_2413.field_1342, (class_243)class_2432);
                                                try {
                                                    try {
                                                        try {
                                                            try {
                                            ...
                                            try {
                                                ...
                                                arrayList2.add(new RaycastResult(class_2413, class_2393));
                                            }
                                            catch (JSONException jSONException) {
                                                throw _0.FontWeight(jSONException);
                                            }
    ...
    public static float RenderEvent(class_241 class_2412, class_241 class_2413) {
    ...
    public static class_243 EventDispatcher() {
        float f = MinecraftHelper.m.field_1724.method_18381(MinecraftHelper.m.field_1724.method_18376());
        return new class_243(MinecraftHelper.m.field_1724.method_23317(), MinecraftHelper.m.field_1724.method_23318() + (double)f, MinecraftHelper.m.field_1724.method_23321());
    }

    public static class_243 n(class_1297 class_12972) {
        class_243 class_2432 = _0.EventDispatcher();
        float f = 0.0f;
    ...
    public static void FontWeight(int[] nArray) {
        Category = nArray;
    }
    ...
    static {
        FontWeight = ObfuscationHelper.FontWeight((long)2653888023721052553L, (long)1927434815995557523L, MethodHandles.lookup().lookupClass()).FontWeight(135791588455464L);
        if (_0.Q() != null) {
            _0.FontWeight(new int[2]);
        }
    }
