        ...
        try {
            ...
            httpServer.createContext("/", httpExchange -> {
                ...
                try {
                    ...
                    MinecraftClientAccessor minecraftClientAccessor = (MinecraftClientAccessor)MinecraftHelper.m;
                    minecraftClientAccessor.setSession(class_3202);
                    Jw.FontWeight().y(MinecraftHelper.m.method_1548().method_1676());
                    EvonClient.p().k().n(class_3202, yg.MICROSOFT);
...
lbl17:
    ...
    public static v_ K(File file) {
        ...
        try {
            ...
            String string10 = zH.RenderEvent(stringArray[56], stringArray[55] + string9 + stringArray[100], true);
            String string11 = ((JsonObject)MinecraftHelper.p.fromJson(string10, JsonObject.class)).get(stringArray[77]).getAsString();
    ...
    private static v_ z(String string) {
        try {
            ...
            JsonObject jsonObject = (JsonObject)MinecraftHelper.p.fromJson(IOUtils.toString((InputStream)httpsURLConnection.getInputStream()), JsonObject.class);
    ...
    public static void R() {
        ...
        block15: {
            ...
            block16: {
                ...
                minecraftClientAccessor = (MinecraftClientAccessor)MinecraftHelper.m;
                v_2 = zD.z(string);
                try {
                    try {
        ...
        minecraftClientAccessor.setSession(class_3202);
        EvonClient.p().k().n(class_3202, yg.TOKEN);
    }
