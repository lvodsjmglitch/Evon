    ...
    public void l(int n, int n2) {
        ...
        block9: {
            ...
            for (Enum enum_ : arrayList) {
                ...
                try {
                    StringArrayHelper.CooldownTimer((float)f2, (float)f, (float)f13, (float)f12, (float)f11, (Color)UIHelper.N((Color)color, (double)d2));
                    z72 = UIHelper2.FontWeight;
