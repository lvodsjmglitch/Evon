...
implements class_5481 {
    ...
    private static final long a = ds.a((long)-6719074980873505722L, (long)2937267724529178991L, MethodHandles.lookup().lookupClass()).a(210696054763605L);
    ...
    public yU(class_5481 var1_1) {
        block25: {
            var2_2 = yU.a ^ 98490802029442L;
            super();
            this.Y = new ArrayList<Q>(64);
            var5_3 = new ArrayList<E>(64);
            var4_4 = gi.S();
            var1_1.accept((class_5224)LambdaMetafactory.metafactory(null, null, null, (ILnet/minecraft/class_2583;I)Z, lambda$new$0(java.util.List int net.minecraft.class_2583 int ), (ILnet/minecraft/class_2583;I)Z)(var5_3));
                                ...
                                block30: {
                                    block34: {
                                        block27: {
                                            block26: {
                                                try {
                                                    v2 = var9_8 < var8_7.size() ? (JX)var8_7.get(var9_8) : null;
                                                }
                                    ...
                                    try {
                                        try {
                                            try {
                                                ...
                                                v10 = ((Q)var5_3.get((int)var12_11)).c;
